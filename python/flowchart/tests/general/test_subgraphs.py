...
class TestSubgraphs(TestFlowchartMain):
    ...
    def test_whitelist_vs_force_collapse_priority(self):
        ...
        with patch.dict(os.environ, {
            ...
            mermaid_output1, metadata1, stdout1, stderr1 = self._run_main_with_file('example_complex_scenario.py')
        ...
        with patch.dict(os.environ, {
            ...
            mermaid_output2, metadata2, stdout2, stderr2 = self._run_main_with_file('example_complex_scenario.py')
    ...
    def test_comprehensive_subgraph_scenarios(self):
        ...
        with patch.dict(os.environ, {
            ...
            mermaid_output3, metadata3, stdout3, stderr3 = self._run_main_with_file('example_complex_scenario.py')
