...
class TestFlowchartClasses(TestFlowchartMain):        
    def test_class_basic(self):
        ...
        mermaid_output, metadata, stdout, stderr = self._run_main_with_file('example_class_basic.py')
    ...
    def test_class_method_calls(self):
        ...
        mermaid_output, metadata, stdout, stderr = self._run_main_with_file('example_class_method_calls.py')
    ...
    def test_complex_scenario(self):
        ...
        mermaid_output, metadata, stdout, stderr = self._run_main_with_file('example_complex_scenario.py')
    ...
    def test_property_method_validation(self):
        ...
        mermaid_output, metadata, stdout, stderr = self._run_main_with_file(
            'example_property_method_validation.py'
        )
    ...
    def test_using_self_in_method(self):
        ...
        with patch.dict(os.environ, {
            ...
            mermaid_output, metadata, stdout, stderr = self._run_main_with_file('example_self_method_calls.py')
